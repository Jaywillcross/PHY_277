...
program hw_7
    ...
    integer, parameter    :: m = 11             ! How many tests 
    ...
    do j = 1, m
        ...
        x_i = lower_bound
        f_of_x_i = a*EXP(-100.0*(x_i-b)**2)
        f_of_x_i_plus_half = a*EXP(-100.0*(x_i + delta_x/2.0 - b)**2)
        f_of_x_i_plus_one = a*EXP(-100.0*(x_i + delta_x - b)**2)
